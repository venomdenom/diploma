...
class DataPreprocessor:
    def __init__(self, file_path: str = DATA_FILE_PATH) -> None:
    ...
    def scale_data(self, scaler_type: str = 'standard') -> None:
        ...
        match scaler_type:
            ...
            case 'robust':
                scaler = RobustScaler()
            case _:
                raise ValueError(f"Scaler type {scaler_type} is not supported. Choose from ['standard', 'minmax', 'robust']")
    ...
    def preprocess(self, 
                   include_handling_missing_values: bool = True, include_encoding: bool = True, include_data_scaling: bool = True,
